    ...
    <header
        ...
        <div class="container max-w-[1130px] mx-auto flex flex-col items-center justify-center gap-[34px] z-10">
            <div class="flex flex-col gap-2 text-center w-fit mt-20 z-10">
                <h1 class="font-semibold text-[60px] leading-[130%]">Level Up with<br>Top-Tier Digital Products</h1>
                <p class="text-lg text-belibang-grey">Save time, boost productivity, and create with confidence.</p>
            </div>
