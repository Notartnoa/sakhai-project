        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-[#1E1E1E] rounded-2xl border border-[#2A2A2A] p-6">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea name="about" id="about" rows="5"
                            ...
                            placeholder="Describe your product...">{{ old('about') }}</textarea>
                        @error('about')
                            <p class="text-red-400 text-sm mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-[#1E1E1E] rounded-2xl border border-[#2A2A2A] p-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" id="cover" name="cover" accept="image/png,image/jpeg,image/jpg"
                                class="hidden" required onchange="previewThumbnail(event)">
                            ...
                            <label for="cover" id="thumbnail-label"
                                ...
                                <div id="upload-placeholder" class="flex flex-col items-center justify-center p-8 text-center">
                                ...
                                <img id="thumbnail-preview" class="hidden w-full h-full object-cover" alt="Thumbnail preview">

                                <div id="preview-overlay"
                                     class="hidden absolute inset-0 bg-gradient-to-t from-black/70 to-transparent
                    ...
                    <div class="mt-6">
                        <div class="flex items-center justify-between mb-3">
                            <label class="block text-sm font-medium text-[#A0A0A0]">Detail Images (1-4 images)</label>
                        ...
                        <div class="relative">
                            <input type="file" id="detail_images" name="detail_images[]" accept="image/png,image/jpeg,image/jpg"
                                class="hidden" multiple onchange="handleDetailImages(event)" required>

                            <label for="detail_images" id="detail-images-label"
                                class="flex flex-col items-center justify-center w-full min-h-[180px]
                                       border-2 border-dashed border-[#414141] rounded-2xl cursor-pointer
                                       bg-[#2A2A2A] hover:bg-[#363636] hover:border-[#595959]
                                       transition-all duration-300 p-6 group
                                       @error('detail_images') border-red-500 @enderror">

                                <div class="w-14 h-14 mb-3 rounded-2xl bg-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                ...
                                <p class="text-sm font-medium text-white mb-1">Upload Detail Images</p>
                                <p class="text-xs text-[#595959] text-center">Select 1-4 images</p>
                            </label>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-[#1E1E1E] rounded-2xl border border-[#2A2A2A] p-6">
                    ...
                    <div>
                        ...
                        <input type="url" id="file_url" name="file_url" value="{{ old('file_url') }}" required
